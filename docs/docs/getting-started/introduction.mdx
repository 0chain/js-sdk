...
The JS SDK is already written in TypeScript, so its TS type definitions are built in.

# Features

#### Easy to Use

The Züs JS SDK offers a fully TypeScript-based API, enabling JavaScript developers to communicate with the [GoSDK](https://github.com/0chain/gosdk) WASM and interact the Züs Network.
