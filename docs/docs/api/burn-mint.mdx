...
| `wallet` | `ActiveWallet` | Active wallet instance | |
...
| `value` | `number` | Value to be sent with the transaction (unused) | |
...
| `amountToken` | `string` | Amount of tokens to mint (as a string) | |
...
| `from` | `string` | Address of the sender | |
| `to` | `string` | Address of the receiver | |
| `amountTokens` | `string` | Amount of tokens to burn (as a string) | |
